...
if object_id('usp_LeadLevelByMonth') is not null
    drop proc usp_LeadLevelByMonth
go


CREATE PROCEDURE  usp_LeadLevelByMonth
AS
BEGIN
	SET NOCOUNT ON;
...
null as Level_10_to_19,
null as Level_20_to_44,
null as Level_45_to_69,
null as Level_70_or_more
...
select LSDym, null as Level_LT10, 
...
grant exec on usp_LeadLevelByMonth to Webrdr

go

exec usp_LeadLevelByMonth
